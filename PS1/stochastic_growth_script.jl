...
include("stochastic_growth_functions.jl") #import the functions that solve our growth model
...
savefig("PS1/results/Value_Functions_s.png")
...
savefig("PS1/results/Policy_Functions_s.png")
...
savefig("PS1/results/Policy_Functions_Changes_s.png")
...
hline!([0], linestyle=:dash, color=:black, label="")
savefig("PS1/results/Value_Function_Differences_s.png")
